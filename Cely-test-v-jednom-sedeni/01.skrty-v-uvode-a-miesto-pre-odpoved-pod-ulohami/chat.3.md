...
###### Out: 4
```
Odpoveď na úlohu 04: B) "S dovolením, potrebujem vyniesť kôš, mohol by ste mi uhnúť z cesty?"
```
##### In: 5
```
...
###### Out: 5
```
Odpoveď na úlohu 05: C) Je dôležité starať sa nielen o svoje pohodlie, ale aj o našu planétu.
```
##### In: 6
```
...
###### Out: 6
```
Nie je k dispozícii žiadna ukážka pre úlohu 06. Prosím zadajte platnú úlohu.
```
##### In: 7
```
...
###### Out: 7
```
Nie je v ukážke žiadne slovo cudzieho pôvodu, pri výslovnosti ktorého sa nerešpektuje pravidlo o mäkčení.
```
##### In: 8
```
...
###### Out: 9
```
D) Dostal za svoje rady zlato. (V ukážke sa hovorí, že Ištar verí, že za svoju mapu dostane viac zlata než kedy dostal od faraóna Sargona, ale v ukážke sa neuvádza, že by už za svoje rady dostal zlato.)
```
##### In: 10
```
...
###### Out: 17
```
Odpoveď na úlohu 17: C) slabá osveta
```
##### In: 18
```
...
###### Out: 19
```
Odpoveď na úlohu 19: B) životné okamihy
```
##### In: 20
```
...
###### Out: 24
```
Spoznaj našu Zem, modrú krásku, a jej vzácnosť.
```
##### In: 25
```
...
| 22 | A | A | 1 |
| 23 | A | B | 0 |
| 24 | Spoznaj našu Zem, modrú krásku, a jej vzácnosť. | (o, v, na, pri...) Zemi  | 0 |
