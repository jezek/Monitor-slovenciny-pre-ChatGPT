...
```
Kam patrí polystyrén a škatule z kartónu?
Polystyrén patrí do žltého kontajnera, určeného na plasty. Škatule z kartónu patria do modrej nádoby, určenej na papierový odpad.
```
##### In: 2
```
...
###### Out: 2
```
B) V prírode by sa sklenená váza rozkladala aj 4000 rokov. (Sklo sa v prírode neznehodnocuje, ale recykluje sa)
```
##### In: 3
```
...
###### Out: 5
```
A) Projekt prispieva k tomu, aby sme sa zaujímali o životné prostredie. (tomu, aby)
```
##### In: 6
```
...
###### Out: 8
```
B) Autor mapy nie je poctivcom, ale pozerá na svoje výhody. (Ištar si tajne ponechal dobrý kus mapy, ktorý vidíte pred sebou, vedel som, že jedného dňa mi zaň niekto zaplatí viac, než sa kedy zmohol Sargon.)
```
##### In: 9
```
...
###### Out: 9
```
D) Dostal za svoje rady zlato (Ištar hovorí, že bude musieť niečo vymyslieť, aby si si zarobil tri vrecia zlata)
```
##### In: 10
```
...
###### Out: 11
```
B) Obsahuje tri rôzne základné číslovky (štvrť, sto, šesť)
```
##### In: 12
```
...
Na ukážku 3 sa vzťahujú úlohy 15 - 21
    ...
    Ktorá veta vyplýva z ukážky?
    A) Mladí ľudia sa nezaujímajú o dobrovoľníctvo.
    B) Mladí ľudia sú prosociálne sa správajúci ľudia.
    C) Mladí ľudia nemajú dostatok informácií o dobrovoľníctve.
    D) Mladí ľudia hľadajú príležitosti na zarobenie.

Odpoveď na úlohu 15: C) Mladí ľudia nemajú dostatok informácií o dobrovoľníctve.
```
##### In: 16
```
...
###### Out: 19
```
Nedá sa určiť na základe uvedenej ukážky, pretože v žiadnom prídavnom mene sa v nej neuplatňuje pravidlo o rytmickom krátení.
```
##### In: 20
```
...
###### Out: 20
```
Vzťah hodnotovej orientácie a dobrovoľníctva.
```
##### In: 21
```
