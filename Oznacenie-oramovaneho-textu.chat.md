...
Patria do žltého kontajnera, určeného na plasty, musia však byť bez zvyškov jedla.", ktora cast je oramovana? vypis prosim.
```
### Out: 1.1
```
Orámovaná časť textu je:
